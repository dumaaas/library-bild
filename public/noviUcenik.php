                        ...
                        <div class="mt-[50px]">
                            <label class="mt-6 cursor-pointer">
                                <div id="empty-cover-art" class="w-48 h-48 py-[48px] text-center border-2 border-gray-300 border-solid">
                                    ...
                                    <img id="image-output-student" class="hidden w-48 h-48 absolute top-[215px] ml-[-1px]" />	
                                </div>
                            </label>  
                        </div>
                    </div>
                        ...
                        <div class="flex flex-row">
                            <div class="inline-block w-full text-right py-[7px] mr-[100px] text-white">
                                ...
                                <button id="sacuvajUcenika" type="submit"
                                        class="shadow-lg w-[150px] disabled:opacity-50 focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] hover:bg-[#46A149] bg-[#4CAF50]" onclick="validacijaUcenik()">
