                  ...
                  <div class="flex justify-start px-8 pt-3 overflow-hidden bg-white">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-sm leading-4 tracking-wider text-left border-b-2 border-gray-300">Kategorija</th>
                        ...
                        <tbody class="bg-white">
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Maksimovic Darinka, Dercanin...</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Udzbenici</td>
                                    <td class="px-6 py-4 text-sm leading-5 text-blue-900 whitespace-no-wrap border-b border-gray-500">
                                        <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900">
                                        <span aria-hidden class="absolute inset-0 bg-transparent bg-yellow-600"></span>
                                ...
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Bubalo Zivkovic, Milka Barjaktarevi...</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Udzbenici</td>
                                    <td class="px-6 py-4 text-sm leading-5 text-blue-900 whitespace-no-wrap border-b border-gray-500">
                                        <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900">
                                        <span aria-hidden class="absolute inset-0 bg-transparent bg-yellow-600"></span>
                                ...
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Romani</td>
                                    <td class="px-6 py-4 text-sm leading-5 text-blue-900 whitespace-no-wrap border-b border-gray-500">
                                        <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900">
