                    ...
                    <table class="min-w-full border-2 border-gray-300">
                        ...
                        <tbody class="bg-white">
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">valentina.kascelan@domain...</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Bibliotekar</td>
                                ...
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">tarik.zaimovic@domain.netcom</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Bibliotekar</td>
                                ...
                                <tr class="border-b-2 border-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">test.akontacijevic@bild-studio...</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Bibliotekar</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">darko.kascelan@bild-studio...</td>
                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">Bibliotekar</td>
