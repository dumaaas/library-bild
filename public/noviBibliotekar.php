                            ...
                            <div id="empty-cover-art" class="w-48 h-48 py-16 text-center border-2 border-gray-300 border-solid">
                                ...
                                <div class="py-4">
                                    <label class="mt-6 cursor-pointer">
                                        ...
                                        <input type='file' class="hidden" :multiple="multiple" :accept="accept" onchange="loadFileLibrarian(event)" />
                                    </label>
                                </div>
                                <img id="image-output-librarian" class="hidden w-48 h-48 absolute top-[215px]" />	
                            </div>
                        </div>
                    </div>
