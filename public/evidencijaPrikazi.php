                        ...
                        <div>
                            <nav class="w-full rounded">
                                <ol class="flex list-reset">
                                    ...
                                    <li>
                                        <a href="evidencijaIznajmljivanja.php" class="font-medium text-blue-600 hover:text-blue-800">
                    ...
                    <table class="w-full border-2 border-gray-300" id="myTable">
                        <thead>
                            <tr class="border-b-2 border-gray-300">
                                ...
                                <th class="px-6 py-3 text-sm leading-4 tracking-wider text-left">Datum akcije<a href="#"><i class="ml-3 fa-lg fas fa-long-arrow-alt-down" onclick="sortTable()"></i></a></th>
