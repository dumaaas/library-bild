    ...
    <main class="flex flex-row small:hidden">
        ...
        <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
            ...
            <div class="height-dashboard pb-[30px] scroll">
                ...
                <div
                    class="inline-block min-w-full px-[50px] pt-3 overflow-hidden align-middle bg-white rounded-bl-lg rounded-br-lg shadow-dashboard">
                        ...
                        <tbody class="bg-white">
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="flex flex-row items-center px-4 py-3">
                                    ...
                                    <a href="#">
                                        <span class="font-medium text-center">Mark Twain</span>
                                    </a>
                                </td>
                                </td>
                            ...
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <img class="object-cover w-8 mr-2 h-11" src="img/profileStudent.jpg" alt="" />
                                    <a href="#">
                                        <span class="font-medium text-center">Danijel Defoe</span>
                                    </a>
                                </td>
                                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, perferendis repudiandae ratione at porro, enim labore illo animi tempora quas neque. Dignissimos voluptates quos possimus...</td>
                                <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                            ...
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <img class="object-cover w-8 mr-2 h-11" src="img/profileStudent.jpg" alt="" />
                                    <a href="#">
                                        <span class="font-medium text-center">Danka Maksimovic</span>
                                    </a>
                                </td>
                                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, perferendis repudiandae ratione at porro, enim labore illo animi tempora quas neque. Dignissimos voluptates quos possimus...</td>
                                <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                            ...
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <img class="object-cover w-8 mr-2 h-11" src="img/profileStudent.jpg" alt="" />
                                    <a href="#">
                                        <span class="font-medium text-center">Bubalo Zivkovic</span>
                                    </a>
                                </td>
                                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, perferendis repudiandae ratione at porro, enim labore illo animi tempora quas neque. Dignissimos voluptates quos possimus...</td>
                                <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
