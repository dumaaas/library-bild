            ...
            <div class="flex flex-row h-full overflow-auto">
                <div class="w-[80%]">
                    ...
                    <div class="py-4 pl-[30px]">
                        <a href="IznajmljivanjeIzdate.php" class="inline hover:text-blue-600 pr-[10px] bg-gray-200">
                            ...
                            <table class="w-full border-[1px] border-[#e4dfdf]" id="myTable">
                                <thead class="bg-[#EFF3F6]">
                                    <tr class="border-b-[1px] border-[#e4dfdf]">
                                        ...
                                        <th class="px-4 py-4 text-sm leading-4 tracking-wider text-left">Trenutno zadrzavanje knjige<i class="ml-2 fas fa-filter"></i></th>
                                        <th class="px-4 py-4 text-sm leading-4 tracking-wider text-left">Knjigu izdao<i class="ml-2 fas fa-filter"></i></th>
