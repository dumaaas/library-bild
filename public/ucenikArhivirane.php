            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <p class="inline cursor-pointer text-[25px] py-[10px] pl-[30px] border-l-[1px] border-gray-300 dotsUcenikKnjigeArhivirane hover:text-[#606FC7]">
                                ...
                                <tbody class="bg-white">
                                    <tr class="border-b-[1px] border-[#e4dfdf]">
                                        ...
                                        <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                            <p class="inline cursor-pointer text-[20px] py-[10px] px-[30px] border-gray-300 dotsUcenikArhiviraneKnjige hover:text-[#606FC7]">
                                                <i class="fas fa-ellipsis-v"></i>
                                            </p>
                                            <div
                                                class="hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 ucenik-arhivirane-knjige-tabela">
                                    ...
                                    <tr class="border-b-[1px] border-[#e4dfdf]">
                                        ...
                                        <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                            <p class="inline cursor-pointer text-[20px] py-[10px] px-[30px] border-[#e4dfdf] dotsUcenikArhiviraneKnjige hover:text-[#606FC7]">
                                                <i class="fas fa-ellipsis-v"></i>
                                            </p>
                                            <div
                                                class="hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 ucenik-arhivirane-knjige-tabela">
