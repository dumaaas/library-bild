                  ...
                  <div class="flex justify-start px-8 pt-3 overflow-hidden bg-white">
                        ...
                        <thead>
                            <tr class="border-b-2 border-gray-300">
                                ...
                                <th class="px-6 py-3 leading-4 tracking-wider text-left">Naziv knjige<i class="ml-3 fa-lg fas fa-long-arrow-alt-down"></i></th>
                                <th class="px-6 py-3 text-sm leading-4 tracking-wider text-left">Autor</th>
                                <th class="px-6 py-3 text-sm leading-4 tracking-wider text-left">Status</th>
